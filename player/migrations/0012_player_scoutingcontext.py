...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('player', '0011_delete_player_delete_scoutingcontext'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scouting_contexts', to='player.player')),
            ],
        ),
    ]
